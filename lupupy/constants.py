...
STATUS_PLUG_ON_INT = 1
STATUS_PLUG_ON = "{WEB_MSG_PSS_ON}"
STATUS_PLUG_OFF_INT = 0
STATUS_PLUG_OFF = "{WEB_MSG_PSS_OFF}"
...
TYPE_OPENING = [TYPE_DOOR, TYPE_WINDOW, TYPE_CONTACT_XT2, TYPE_MOTION]
TYPE_KEYPADS = [TYPE_KEYPAD_XT2]
